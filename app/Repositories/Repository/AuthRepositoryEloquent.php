...
use App\Repositories\Contracts\AuthRepository as UserAuthRepository;
...
class AuthRepositoryEloquent extends BaseRepository implements UserAuthRepository
{
    /**
     ...
     * @return [void]
     */
    public function postSignup($attributes)
    {
        dd('Ganteng');
