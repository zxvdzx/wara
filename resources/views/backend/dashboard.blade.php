        ...
        <div class="col-md-4">
            <div class="col-md-12 padding-0">
                <div class="panel box-v2">
                    ...
                    <img src="{{ asset($pathp.'assets/backend/img/bg2.jpg')}}" class="box-v2-cover img-responsive"/>
                    <div class="box-v2-detail">
                        <img src="{{ asset($pathp.'assets/backend/img/avatar.jpg')}}" class="img-responsive"/>
                        <h4>Admin User</h4>
                    </div>
                    </div>
                    <div class="panel-body">
