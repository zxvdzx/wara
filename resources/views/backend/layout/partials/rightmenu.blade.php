<div id="right-menu">
              ...
              <div class="tab-content">
                <div id="right-menu-user" class="tab-pane fade in active">
                  ...
                  <div class="user col-md-12">
                   <ul class="nav nav-list">
                    <li class="online">
                      <img src="{{ asset($pathp.'assets/backend/img/avatar.jpg')}}" alt="user name">
                      <div class="name">
                ...
                <div class="col-md-12 chatbox">
                  <div class="col-md-12">
                    <a href="#" class="close-chat">X</a><h4>Admin User</h4>
                  </div>
                  <div class="chat-area">
                        ...
                        <div class="row msg_container send">
                          <div class="col-md-9 col-xs-9 bubble">
                            ...
                            <div class="col-md-3 col-xs-3 avatar">
                              <img src="{{ asset($pathp.'assets/backend/img/avatar.jpg')}}" class=" img-responsive " alt="user name">
                            </div>
                          </div>
                          ...
                          <div class="row msg_container receive">
                            ...
                            <div class="row msg_container send">
                              ...
                              <div class="user-list">
                                <ul>
                                  <li class="online">
                                    <a href=""  data-toggle="tooltip" data-placement="left" title="Admin User">
                                      <div class="user-avatar"><img src="{{ asset($pathp.'assets/backend/img/avatar.jpg')}}" alt="user name"></div>
                                      <div class="dot"></div>
                                    </a>
                                  </li>
                                  <li class="offline">
